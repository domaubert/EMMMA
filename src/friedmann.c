...
double f_aexp(double aexp, double omegam, double omegav)
{
...
double a2t(struct PARAM *param, double a){
  double t=integ_da_dt(1e-8,a,param->cosmo->om,param->cosmo->ov,1e-8);
