...
#if 1
//==================================================================================
void read_grafic_part(struct CPU *cpu, REAL *munit, REAL *ainit, unsigned long *npart, struct PARAM *param,int level)
{

  struct PART *part =cpu->part;
  const int debug=1;
...
/* #endif */
	...
	//if(segment_part(x,y,z,cpu,cpu->levelcoarse)){ // TO PUT BACK AFTER MPI
	if(1){
